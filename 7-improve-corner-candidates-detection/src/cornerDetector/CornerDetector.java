...
public class CornerDetector {
    ...
    public Corner finCornerCandidatesIn(Mat image) {

        List<Corner> candidateCorners = new ArrayList<>();
        List<Corner> candidateCornerHarris = detectCandidateCornersByHarrisDetection(image);
        List<Corner> candidateCornerEllipsis = detectCandidateCornersByEllipsisFit(image);
